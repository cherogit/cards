...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Catalog\", function() { return Catalog; });\n/* harmony import */ var _counter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./counter */ \"./app/counter.ts\");\n/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./slider */ \"./app/slider.ts\");\n\r\n\r\nclass Catalog {\r\n    constructor($container, cards, cateroryType) {\r\n        this.$container = $container;\r\n        this.cards = cards;\r\n        this.cateroryType = cateroryType;\r\n        this.$el = document.createElement('div');\r\n        this.$category = document.createElement('div');\r\n        this.$category_name = document.createElement('span');\r\n        this.counter = new _counter__WEBPACK_IMPORTED_MODULE_0__[\"Counter\"](this.$el, this.cards);\r\n        this.slider = new _slider__WEBPACK_IMPORTED_MODULE_1__[\"Slider\"](this.$el, this.cards);\r\n        this.$el.classList.add('catalog', 'container');\r\n        this.$el.setAttribute('data-type', cateroryType);\r\n        this.$container.appendChild(this.$el);\r\n        this.$category.classList.add('catalog__category');\r\n        this.$el.prepend(this.$category);\r\n        this.$category_name.classList.add('catalog__category-name');\r\n        this.$category_name.innerText = cateroryType;\r\n        this.$category.appendChild(this.$category_name);\r\n        this.counter.onChange = (current) => {\r\n            this.slider.current = current;\r\n            this.slider.$el.innerHTML = '';\r\n            this.slider.render();\r\n        };\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./app/catalog.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _card__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./card */ \"./app/card.ts\");\n/* harmony import */ var _generate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./generate */ \"./app/generate.ts\");\n/* harmony import */ var _style_styl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.styl */ \"./app/style.styl\");\n/* harmony import */ var _style_styl__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_style_styl__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _catalog__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./catalog */ \"./app/catalog.ts\");\n\r\n\r\n\r\n\r\nlet $main = document.querySelector('main');\r\nconst data = Object(_generate__WEBPACK_IMPORTED_MODULE_1__[\"genItems\"])(100);\r\ndata.forEach((card) => _card__WEBPACK_IMPORTED_MODULE_0__[\"cards\"].push(card));\r\nconst checkboxes = document.querySelectorAll('.checkbox__field');\r\ncheckboxes.forEach((item) => {\r\n    item.addEventListener('change', () => {\r\n        if (item.checked === true) {\r\n            if (!$main)\r\n                throw Error('Контейнер не найден');\r\n            const _cards = _card__WEBPACK_IMPORTED_MODULE_0__[\"cards\"].filter((card) => card.type === item.dataset.type);\r\n            new _catalog__WEBPACK_IMPORTED_MODULE_3__[\"Catalog\"]($main, _cards, item.dataset.type);\r\n        }\r\n        else {\r\n            const currentCatalog = document.querySelector(`.catalog[data-type=\"${item.dataset.type}\"]`);\r\n            if (!currentCatalog)\r\n                throw Error('Искомый каталог не найден.');\r\n            currentCatalog.remove();\r\n        }\r\n    });\r\n});\r\n\n\n//# sourceURL=webpack:///./app/index.ts?");
